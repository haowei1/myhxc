...
import com.hdy.myhxc.model.RoleAuthorityExample.Criteria;
import com.hdy.myhxc.model.RoleAuthorityExample.Criterion;
...
public class RoleAuthoritySqlProvider {
     ...
     */
    public String countByExample(RoleAuthorityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("m_roleauthority");
     ...
     * @mbg.generated Mon Aug 26 14:48:07 CST 2019
     */
    public String deleteByExample(RoleAuthorityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("m_roleauthority");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(RoleAuthority record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("m_roleauthority");
     ...
     * @mbg.generated Mon Aug 26 14:48:07 CST 2019
     */
    public String selectByExample(RoleAuthorityExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        RoleAuthorityExample example = (RoleAuthorityExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("m_roleauthority");
     ...
     * @mbg.generated Mon Aug 26 14:48:07 CST 2019
     */
    protected void applyWhere(SQL sql, RoleAuthorityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
